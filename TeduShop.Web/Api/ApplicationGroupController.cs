    ...
    public class ApplicationGroupController : ApiControllerBase
    {
        ...
        public HttpResponseMessage GetListPaging(HttpRequestMessage request,int page,int pageSize,string filter = null)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                PaginationSet<ApplicationGroupViewModel> pagadset = new PaginationSet<ApplicationGroupViewModel>()
                {
                    Page = page,
                    TotalCount = totalRow,
                ...
                response = request.CreateResponse(HttpStatusCode.OK, pagadset);
        ...
        public HttpResponseMessage Create(HttpRequestMessage request, ApplicationGroupViewModel appGroupViewmodel)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    {
                        listroleGroup.Add(new ApplicationRoleGroup { RoleId = role.Id, GroupId = appgroup.ID });
                    }
